...
function Registration() {
  ...
  const handleFormData=(e)=>{
    ...
    setFormData({name:e.target[0].value,usn:e.target[1].value,email:e.target[2].value,imgLink:e.target[3].value,githubLink:e.target[4].value,linkedinLink:e.target[5].value})
  }
  useEffect(()=>{
    if(isFormSetted){
